...
class OCR(Base, Form):
    ...
    def r_analyse(self):
        ...
        routeanalyse(getlatA, getlongA, getlatB, getlongB)
        self.update_map(self, getlongA, getlatA, 0)     
